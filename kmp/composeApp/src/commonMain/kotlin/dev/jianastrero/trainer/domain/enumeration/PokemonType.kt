...
enum class PokemonType(
    ...
    @JsonNames("steel", "Steel", "Metal") Steel(Color(0xFFB7B7CE), Res.drawable.steel),
    ...
    @JsonNames("electric", "Electric", "Lightning") Electric(Color(0xFFF7D02C), Res.drawable.electric),
    ...
    @JsonNames("dark", "Dark", "Darkness") Dark(Color(0xFF705746), Res.drawable.dark),
    @JsonNames("fairy", "Fairy") Fairy(Color(0xFFD685AD), Res.drawable.fairy),
    @JsonNames("stellar", "Stellar") Stellar(Color(0xFF46647E), null),
    @JsonNames("unknown", "Unknown", "Colorless") Unknown(Color(0xFF827E7A), null),
